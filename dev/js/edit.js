						...
						<PanelRow>
							<SelectControl
								...
								options = { [
									...
									{ label: 'Ada', value: 'ada' },
									{ label: 'Alpine.js', value: 'alpine | alpinejs' },
									{ label: 'Apex', value: 'apex' },
									{ label: 'Applescript', value: 'applescript' },
									{ label: 'Assembly', value: 'asm' },
									{ label: 'AWK', value: 'awk' },
									{ label: 'Batch', value: 'bat | batch' },
									{ label: 'C', value: 'c' },
									{ label: 'C#', value: 'csharp | c#' },
									{ label: 'C++', value: 'cpp' },
									{ label: 'Clojure', value: 'clojure | clj' },
									...
									{ label: 'Elm', value: 'elm' },
									{ label: 'Embedded Ruby (ERB)', value: 'html-ruby-erb | erb' },
									{ label: 'Erlang', value: 'erlang' },
									{ label: 'F#', value: 'fsharp | f#' },
									{ label: 'git-commit', value: 'git-commit' },
									{ label: 'git-diff', value: 'diff' },
									{ label: 'git-ignore', value: 'git-ignore | gitignore' },
									...
									{ label: 'Handlebars', value: 'handlebars | hbs' },
									...
									{ label: 'JavaScript', value: 'javascript | js' },
									...
									{ label: 'Latex', value: 'latex | tex' },
									{ label: 'Less', value: 'less' },
									{ label: 'Lisp', value: 'lisp' },
									{ label: 'Logo', value: 'logo' },
									{ label: 'Lua', value: 'lua' },
									{ label: 'Makefile', value: 'makefile' },
									{ label: 'Markdown', value: 'markdown | md' },
									{ label: 'MATLAB', value: 'matlab' },
									{ label: 'MDX', value: 'mdx' },
									{ label: 'Nix', value: 'nix' },
									{ label: 'Objective-C', value: 'objective-c | objc' },
									{ label: 'OCaml', value: 'ocaml' },
									{ label: 'Pascal', value: 'pascal' },
									{ label: 'Perl', value: 'perl' },
									{ label: 'Perl6', value: 'perl6' },
									{ label: 'PHP', value: 'php' },
									{ label: 'Plaintext', value: '(null) | txt | text | plaintext' },
									{ label: 'PLSQL', value: 'pls' },
									{ label: 'PostCSS', value: 'postcss' },
									{ label: 'PowerShell', value: 'powershell | ps | ps1' },
									...
									{ label: 'ShaderLab', value: 'shaderlab | shader' },
									{ label: 'Shell', value: 'shell' },
									{ label: 'Smalltalk', value: 'smalltalk' },
									{ label: 'SQL', value: 'sql' },
									{ label: 'ssh-config', value: 'ssh-config' },
									{ label: 'Statamic Antlers', value: 'antlers' },
									{ label: 'Stylus', value: 'stylus | styl' },
									{ label: 'Swift', value: 'swift' },
									{ label: 'Tcl', value: 'tcl' },
									{ label: 'TOML', value: 'toml' },
									{ label: 'tsx', value: 'tsx' },
									{ label: 'TypeScript', value: 'typescript | ts' },
									{ label: 'VB', value: 'vb | cmd' },
									{ label: 'VimL', value: 'viml' },
									{ label: 'Vue', value: 'vue' },
									{ label: 'WebAssembly', value: 'wasm' },
									{ label: 'Wenyan', value: '文言 | wenyan' },
									{ label: 'XML', value: 'xml' },
									{ label: 'XSL', value: 'xsl' },
